...
const getAllPokemons = async () => {
    const listePokemons = [];
    const url = `https://pokeapi.co/api/v2/pokemon?offset=${offset}&limit=10000`;
...
const fillPokemonsList = async(listePokemons) => {
    ...
    for (let i = offset; i < listePokemons[0] + offset; i++){
        ...
        if (i > 898){
            ...
            if (listePokemons[i-searchOffset][0] === "kommo-o-totem" || listePokemons[i-searchOffset][0] === "mr-mime-galar" || listePokemons[i-searchOffset][0].split('-')[0] === "great" || listePokemons[i-searchOffset][0].split('-')[0] === "scream" || listePokemons[i-searchOffset][0].split('-')[0] === "brute" || listePokemons[i-searchOffset][0].split('-')[0] === "flutter" || listePokemons[i-searchOffset][0].split('-')[0] === "slither" || listePokemons[i-searchOffset][0].split('-')[0] === "sandy" || listePokemons[i-searchOffset][0].split('-')[0] === "iron" || listePokemons[i-searchOffset][0].split('-')[0] === "ting" || listePokemons[i-searchOffset][0].split('-')[0] === "chien" || listePokemons[i-searchOffset][0].split('-')[0] === "wo" || listePokemons[i-searchOffset][0].split('-')[0] === "chi" || listePokemons[i-searchOffset][0].split('-')[0] === "roaring" || listePokemons[i-searchOffset][0].split('-')[0] === "walking" || listePokemons[i-searchOffset][0].split('-')[0] === "gouging" || listePokemons[i-searchOffset][0].split('-')[0] === "raging"){
